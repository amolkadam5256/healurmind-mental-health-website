...
const AboutHeroSection = () => {
    ...
    return (
        <section className="py-5 relative bg-[#F8F8FF] dark:bg-[#0D0D0D]">
                    ...
                    >
                        <div className="w-full flex-col justify-center items-start gap-8 flex">
                            <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                <h1 className="text-lg font-semibold text-[#3B3973] uppercase tracking-wider">
                                    About Us
                                </h1>
                                ...
                                <p className="text-[#7E7CA6] text-base leading-relaxed lg:text-start text-center">
                                    At <strong className="text-[#2F2D73]">HealUrMind</strong>, we believe healing starts from within.
                                    Our empathetic counselors create a safe, non-judgmental space where you can explore your emotions,
                                    overcome inner struggles, and rediscover your strength.
                                </p>
                                <p className="text-[#7E7CA6] text-base leading-relaxed lg:text-start text-center">
                                    Whether you're seeking emotional clarity, personal growth, or healthier relationships,
                                    <strong className="text-[#2F2D73]">HealUrMind</strong> is your trusted companion on the path to mental wellness.
                                    Let us help you turn challenges into opportunities for transformation and peace.
                                </p>
